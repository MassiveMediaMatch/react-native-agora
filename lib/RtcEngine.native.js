...
class RtcEngine {
    ...
    static on(eventType, listener) {
        const eventSubscription = AgoraEventEmitter.addListener(`${RtcEngine.AG_PREFIX}${eventType}`, listener);
        this.eventTypes.add({ eventType, subscription: eventSubscription })
    }
    /**
    ...
    static removeAllListeners() {
        ...
        for (let event of this.eventTypes) {
            AgoraEventEmitter.removeSubscription(event.subscription)
        }
